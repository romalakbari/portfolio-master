...
export default function Home() {
  return (
    <>
      <Head>
        <title>Romal Akbari| Home Page</title>
        ...
        <Layout className='pt-0  md:pt-16 sm:pt:8'>
              ...
              <div className="flex items-center justify-between w-full lg:flex-col">
                    ...
                    <div className="w-1/2 md:w-full">
                        <Image src={ProfilPic} alt="RomalKhan" className="w-full h-auto lg:hidden md:inline-block  md-w-full" 
                         priority
...
Explore my latest projects and articles, showcasing my expertise in React.js and web development.</p>
                      ...
                      <div className="flex items-center self-start mt-2 lg:self-center">
                          ...
                          <Link href="mailto:romalakbari93@gmail.com" target ={"_blank"}
                          className="ml-4 text-lg font-medium capitalized text-dark underline dark:text-light md:text-base"
                          >Contact</Link>
                      </div>
                    </div>
              </div>
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">
           <Image src={LightBulb} alt="Peshaha"  className="w-full h-auto" />
        </div>
