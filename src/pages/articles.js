...
const MovingImag = ({ title, img, link }) =>{
...
const Article =({img, title, date, link})=>{
    ...
    return (
        ...
        '>
            <MovingImag title ={title} img ={img} link ={link} />
...
const FeaturedAarticle = ({img, title, time, summery, link})=>{
    ...
    return (
        ...
        <li className='relative w-full p-4 col-span-1 bg-light border border-dark border-solid rounded-2xl  dark:bg-dark dark:border-light'>
            ...
            <Link href={link} target ='_blank'>
                <h2 className='hover:underline capitalize text-2xl font-bold my-2 mt-4 hover:underline xs:tex-lg  dark:text-light'>{title}</h2>
            </Link>
